 ...
 int count1=0;
  ...
  double c8=0.0;
		...
		System.out.println("Connected");
    		...
    		ResultSet rs=st.executeQuery("select * from Cluster4");
    		...
    		while(rs.next()==true)
    		{
    		   ...
    		   DefaultCategoryDataset dataSet = new DefaultCategoryDataset();
    	        ...
    	        JFreeChart chart = ChartFactory.createBarChart(
    	                "Block chain-based data storage with privacy and authentication in IOT -- Cluster4", "Node Category", "Energy",
